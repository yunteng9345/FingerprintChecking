        ...
        if (student1 == null) {
            ...
            if (check5 == null) {
                ...
                if (checkService.selectOne(check) == null) {
                    ...
                    mode.addAttribute("mesg", "今天第一次打卡完成！");
                    mode.addAttribute("title", fid);
                    return "check";
                    ...
                    if (check22.getFlag() == '1') {
                        ...
                        mode.addAttribute("mesg", "今天第二次打卡完成！");
                        mode.addAttribute("title", fid);
                        return "check";
                    }
                }
            ...
            else if(check5!=null && check5.getFlag()=='2' ){
                ...
                System.out.println("打卡时间" + dateString);
                System.out.println("系统时间" + dateString1);
                if (check5.getFlag() == '2' && dateString.equals(dateString1)) {
                    mode.addAttribute("mesg", "您今天已经打卡俩次！请不要重复操作！");
                    mode.addAttribute("title", fid);
                    return "check";
                }
            }
